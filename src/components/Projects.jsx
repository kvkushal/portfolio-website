 ...
 * Shows: thumbnail, title, short description, quick links
 * Clickable to go to detail page
 */
...
/**
 * Projects Section - Featured projects on homepage
        ...
        <section id="projects" className="py-20 bg-cream">
            ...
            >
                ...
                >
                    <Link
                        to="/projects"
                        className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium btn-fill rounded-lg"
                    >
